...
namespace ERestaurant.Areas.Admin.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Category_id,Name,Price,Description,Image,Active")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Category_id,Name,Price,Description,Image,Active")] Product product)
        {
            if (ModelState.IsValid)
            {
